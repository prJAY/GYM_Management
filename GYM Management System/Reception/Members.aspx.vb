...
Public Class Members
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For i = 0 To ds.Tables(0).Rows.Count - 1
            ...
            cell_dob.Text = ds.Tables(0).Rows(i).Item(3).ToString
            cell_edit.Text = "<a href='MemberDetails.aspx?q=" + cell_id.Text + "' class='text-decoration-none stretched-link'>View</a>"
