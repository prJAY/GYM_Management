...
Public Class Users
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For i = 0 To ds.Tables(0).Rows.Count - 1
            ...
            Dim cell_type As New TableCell
            ...
            cell_type.Text = ds.Tables(0).Rows(i).Item(4).ToString
            Select Case cell_type.Text
                Case "M"
                    cell_type.Text = "Manager"
                Case "R"
                    cell_type.Text = "Receptionist"
                Case "T"
                    cell_type.Text = "Trainer"
            End Select

            cell_edit.Text = "<a href='EditUser.aspx?q=" + cell_id.Text + "' class='text-decoration-none stretched-link'>Edit</a>"

            row.Cells.Add(cell_id)
            row.Cells.Add(cell_name)
            row.Cells.Add(cell_type)
